resource "aws_iam_role" "my-project-eks" {
  name = "eks-cluster-my-project-eks-${var.ENV_NAME}"
...
resource "aws_iam_role" "my-project-eks-node-group" {
  name = "eks-node-group-my-project-${var.ENV_NAME}"
...
resource "aws_iam_role_policy_attachment" "eks-node-group-AmazonEKSWorkerNodePolicy" {
  ...
  role       = aws_iam_role.my-project-eks-node-group.name
}
...
resource "aws_iam_role_policy_attachment" "my-project-eks-AmazonEKSClusterPolicy" {
  ...
  role       = aws_iam_role.my-project-eks.name
}
